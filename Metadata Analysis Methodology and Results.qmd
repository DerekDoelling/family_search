...
Unless someone is very familiar with MARC, these columns names don't mean anything significant. In an effort to make the data more understandable, we will rename the columns to something more meaningful. Columns were renamed according to the mark standard found [here](https://www.loc.gov/marc/bibliographic/).
